...
git clone --depth=1 https://github.com/texascake/android_device_asus_X00TD -b sakura device/asus/X00TD
...
git clone https://github.com/inexdroid/keys sig && cp -R sig/* vendor/sakura-priv/ && rm -rf sig
